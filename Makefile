...
ACLOCAL = ${SHELL} /home/jason/zebra-0.95a/missing --run aclocal-1.6
AUTOCONF = ${SHELL} /home/jason/zebra-0.95a/missing --run autoconf
AUTOMAKE = ${SHELL} /home/jason/zebra-0.95a/missing --run automake-1.6
AUTOHEADER = ${SHELL} /home/jason/zebra-0.95a/missing --run autoheader
...
OBJEXT = o
PATH_SEPARATOR = :
AMTAR = ${SHELL} /home/jason/zebra-0.95a/missing --run tar
AR = ar
AWK = gawk
BGPD = bgpd
CC = gcc
...
am__include = include
am__quote = 
install_sh = /home/jason/zebra-0.95a/install-sh
